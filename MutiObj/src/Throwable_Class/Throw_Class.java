...
//        int[] arr=null;
    ...
    int[] arr
    int index
    以后（工作中）我们首相必须对方法传递过来的参数进行合法性校验
    ...
    public static int getElement(int []arr,int index){
        ...
        if(index<0||index>arr.length-1){
            throw new ArrayIndexOutOfBoundsException("数组的索引越界了");//Exception in thread "main" java.lang.ArrayIndexOutOfBoundsException: 数组的索引越界了
        }
        int ele=arr[index];
        return ele;
    }
