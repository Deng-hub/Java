package IO.Buffered.BufferedInputStream;
...
2.创建BufferedInputStream对象，构造放法中传递FileInputStream对象，提高FileInputStream对象的读取效率
3.使用BufferedInputStream对象中的放法read,读取文件
4.释放资源
 */
