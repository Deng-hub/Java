package FunctionalInterface.ConsumerInterface.ConsumerInterface3;

import java.util.function.Consumer;

/*
练习：
字符数组当中存有多条信息，请按照格式：姓名：xx，性别:xx"的格式将信息打印出来“
要求将答应姓名的动作作为第一个Consumer接口的Lambda实例，
将打印性别的动作作为第二个Consumer接口的Lambda实例
将两个Consumer金额口按照顺序"拼接”到一起。
 */
